...
public class FourthFragmentQuiz extends Fragment {
    ...
    public static int mScore3 = 0;
    private int mQuestionNumber = 12;

    public FourthFragmentQuiz() {
