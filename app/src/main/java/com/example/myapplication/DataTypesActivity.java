...
public class DataTypesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_main_data);
        sp = PreferenceManager.getDefaultSharedPreferences(this);
        spEditor = sp.edit();
        tabLayout = (TabLayout) findViewById(R.id.tabLayout);
        fragment = new FirstFragmentData();
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (pos) {
                    ...
                    case 1:
                        System.out.println("CASE 0 REACHED");
                        fragment = new SecondFragmentData();
                        break;
                }
                FragmentManager fm = getSupportFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.aboutMenu:
                ...
                break;
            case R.id.logout:
                AlertDialog.Builder alert = new AlertDialog.Builder(DataTypesActivity.this);
