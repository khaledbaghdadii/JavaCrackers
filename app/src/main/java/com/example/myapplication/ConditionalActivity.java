...
public class ConditionalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_main_conditionals);
        sp = PreferenceManager.getDefaultSharedPreferences(this);
        spEditor = sp.edit();
        tabLayout = (TabLayout)findViewById(R.id.tabLayout) ;
        fragment=new FirstFragmentConditionals();
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (pos) {
                    ...
                    case 1:
                        ...
                        fragment = new SecondFragmentConditionals();
                        break;
                }
                FragmentManager fm = getSupportFragmentManager();
                FragmentTransaction ft = fm.beginTransaction();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()){
            ...
            case R.id.aboutMenu:
                ...
                break;
            case R.id.logout:
                AlertDialog.Builder alert = new AlertDialog.Builder(ConditionalActivity.this);
